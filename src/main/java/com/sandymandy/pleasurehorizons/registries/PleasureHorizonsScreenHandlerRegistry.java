...
public class PleasureHorizonsScreenHandlerRegistry {
    ...
    // Dummy MenuTypes for compilation - actual registry uses holders
    @SuppressWarnings("unchecked")
    public static final MenuType<?> GIRL_INVENTORY_SCREEN_HANDLER = new MenuType<>((id, inv) -> null);
    @SuppressWarnings("unchecked")
    public static final MenuType<?> SETTLEMENT_HUB_SCREEN_HANDLER = new MenuType<>((id, inv) -> null);

    public static final DeferredHolder<MenuType<?>, MenuType<?>> GIRL_INVENTORY_HOLDER =
            MENU_TYPES.register("girl_inventory_screen", () -> (MenuType<?>) GIRL_INVENTORY_SCREEN_HANDLER);
    public static final DeferredHolder<MenuType<?>, MenuType<?>> SETTLEMENT_HUB_HOLDER =
            MENU_TYPES.register("settlement_hub", () -> (MenuType<?>) SETTLEMENT_HUB_SCREEN_HANDLER);
