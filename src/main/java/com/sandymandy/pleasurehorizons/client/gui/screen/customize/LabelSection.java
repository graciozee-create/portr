...
public class LabelSection<T extends GirlSceneEntity> extends CustomizeSection<T> {
    ...
    // Fabric original accepted net.minecraft.text.Text - also support String for convenience
    ...
    public int render(CustomizeScreen<T> screen, CustomizeScreen.LayoutConfig layout, int currentY) {
        // StringWidget is the Mojang equivalent of TextWidget in Yarn
        StringWidget widget = new StringWidget(layout.centerX, currentY, layout.contentWidth, 20, text,
