...
public class SceneProgressOverlay {
    private static final ResourceLocation SCENE_PROGRESS_BAR_TEXTURE = ResourceLocation.fromNamespaceAndPath(PleasureHorizons.MOD_ID, "textures/gui/scene_progress_bar.png");
    private static final ResourceLocation READY_TO_CUM_TEXTURE = ResourceLocation.fromNamespaceAndPath(PleasureHorizons.MOD_ID, "textures/gui/cum_button.png");
