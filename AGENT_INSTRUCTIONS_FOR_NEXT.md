...
> Всё ниже собрано и проверено CI (последний зелёный прогон — `31615267271`).
...
Константы посадки вынесены наверх `GirlRenderer` (`SHOULDER_RIGHT`, `SHOULDER_UP`,
`SHOULDER_FORWARD`, `CARRY_SCALE`, углы `CARRY_*`) — правится там.
